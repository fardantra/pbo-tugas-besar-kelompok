 ...
 * @author Fardan
 */
public class CariReservasi extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CariReservasi.class.getName());

    /**
     * Creates new form Login
     */
    public CariReservasi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        judulLabel.setText("Cari Reservasi");
        ...
        statusPembayaranLabel.setText("Status:");
        ...
        setSize(new java.awt.Dimension(763, 639));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(CariReservasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> new CariReservasi().setVisible(true));
    }
